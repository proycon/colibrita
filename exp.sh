...
colibrita --train -f $TRAINSET -l 1 -r 1 -o exp-l1r1
...
colibrita --train -f $TRAINSET -l 1 -r 1 -k -o exp-l1r1k
...
colibrita --train -f $TRAINSET -l 2 -r 2 -o exp-l2r2
...
colibrita --train -f $TRAINSET -l 2 -r 2 -k -o exp-l2r2k
...
colibrita --train -f $TRAINSET -l 3 -r 3 -o exp-l3r3
...
colibrita --train -f $TRAINSET -l 3 -r 3 -k -o exp-l3r3k
...
colibrita --train -f $TRAINSET -l 1 -r 0 -o exp-l1r0
...
colibrita --train -f $TRAINSET -l 2 -r 0 -o exp-l2r0
...
colibrita --train -f $TRAINSET -l 3 -r 0 -o exp-l3r0
...
colibrita --train -f $TRAINSET -l 5 -r 5 -k -a -o exp-al5r5k
